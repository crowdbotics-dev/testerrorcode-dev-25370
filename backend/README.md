...
## Project Structure
    ...
    ├── testerrorcode_dev_25370  # Django project configurations
...
1. Clone this repo and `cd testerrorcode_dev_25370`
...
2. Clone this repo and `cd testerrorcode_dev_25370`
